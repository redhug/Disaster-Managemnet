    ...
    renderIncidents() {
        return (
            <div className="signup mt20">
                <div>
                    <h2>{this.state.userDetails.firstName} {this.state.userDetails.lastName}</h2>
                </div>
                <form>
                    ...
                    <div className="mt20">
                        <b htmlFor="certificationCheck">
                            Do you want to make this user as admin</b>
                        <div className="mb10">
                ...
                <div className="mt20 text-center">
                    ...
                    <Button onClick={this.rejectUserRequest} name="reject" className="ml2" >
                        Reject
                    </Button>
                </div>
            </div>
